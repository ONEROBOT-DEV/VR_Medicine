...
namespace TVP.UI
{
    ...
    public class SimStateCanvas : MonoSinglethon<SimStateCanvas>
    {
        ...
        {
            if(SimulationStaticDataManager.GetCurrentStudentFromPlayerPrefs()!=null)
                _dataManagerDebug.text = SimulationStaticDataManager.GetCurrentStudentFromPlayerPrefs().GetText();
