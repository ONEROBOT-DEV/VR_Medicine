...
namespace TVP
{
    public class UziDevice : MonoSinglethon<UziDevice>
    {
        ...
        public Transform Adapter { get => _adapter; set => _adapter = value; }
        public Transform Niddle { get => _niddle; set => _niddle = value; }
        ...
        public void AttachNiddle()
        {
            ...
            _adapter.GetComponent<Grabbable>().enabled = false;
        ...
        {
            _adapter.GetComponent<Grabbable>().enabled = true;
            if (_niddle == null)
                return;
