...
namespace TVP.Scene06
{
    public class Scene06_02_Start : SimDomenState
    {
        ...
        public override void Enter(SimDomenStateMachine stateMachine)
        {
            ...
            OutlineManager.CurrentSimulation.ShowModel(OutlineManager.CurrentSimulation.HandL);
            OutlineManager.CurrentSimulation.ShowModel(OutlineManager.CurrentSimulation.HandR); 
        }
