...
namespace TVP
{
    public class TimeMachine : MonoBehaviour
    {
        ...
        [field: SerializeField] public float TotalSecond { get; private set; }
        ...
        {
            CanCountSecond = Common.DataManager.SimulationManagerDataContainer.TVPTest;
            StopAllCoroutines();
        ...
        {
            if(Common.DataManager.SimulationManagerDataContainer.TVPNegativeTest)
                amount = -100;
