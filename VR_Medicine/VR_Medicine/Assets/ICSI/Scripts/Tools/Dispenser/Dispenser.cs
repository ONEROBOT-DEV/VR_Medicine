...
public class Dispenser : MonoBehaviour, IOculusControllerButtonDownListener, IOculusControllerButtonUpListener
{
    ...
    private int countClickToInvoke = 1;
    ...
    public void InitializeStripper()
    {
        isInitializeTip = true;
    }

    public void SetCounterToInvoke(int value)
    {
        countClickToInvoke = value;
    }

    public void ResetTip()
    {
        tip.gameObject.SetActive(false);
        isInitializeTip = false;
        counterClick = 0;
    }
    ...
    public void OnClickPrimaryButtonDown(Hand hand, CommonButton button)
    {
        ...
        counterClick++;
        if (counterClick >= countClickToInvoke)
        {
            counterClick = 0;
