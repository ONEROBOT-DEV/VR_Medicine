...
public class TutorialController : MonoBehaviour
{
    ...
    public void ShowPrimaryButton(Grabbable grabbable, bool isLeft)
    {
        if (isLeft)
        {
    ...
    public void StartShowTutorial(Hand hand, Grabbable grabbable)
    {
    ...
    private void DisableTutorial(Hand hand, Grabbable grabbable)
    {
        if (listenedObjectDictinary.ContainsKey(grabbable))
        {
            if (hand.left && lastLeftGrabbable == grabbable)
            {
                lastLeftGrabbable = null;
                lastLeftTutorial?.DisablePanel();
                lastLeftTutorial = null;
            }
            else if (!hand.left && lastRightGrabbable == grabbable)
            {
...
public interface ITutorialDisabler
{
    ...
    void StartTutorial(bool value = true);
